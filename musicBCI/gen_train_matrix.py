...
def gen_training_matrix_bci(directory_path, filename, output_file):
    # Initialise return matrix
    FINAL_MATRIX = None

    print('Using file', filename)
    full_file_path = directory_path + '/' + filename
    vectors, header = generate_feature_vectors_from_bci(file_path=full_file_path,
                                                                nsamples=150,
                                                                period=1.,
                                                                #remove_redundant=True,
                                                                cols_to_ignore=None)
...
"""
    ...
    if len(sys.argv) == 4:
        ...
        gen_training_matrix_bci(directory_path, filename, output_file)
    else:"""
    directory_path = sys.argv[1]
